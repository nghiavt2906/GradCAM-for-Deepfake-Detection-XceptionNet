...
### Conclusion
From the evaluation metrics and Grad-CAM images, We can see that the pretrained model failed to recognize most of the videos generated by Deepfake while only 2 `REAL` videos were misclassified as `FAKE`. This can be interpreted as because images from Celeb-DF dataset
### References
